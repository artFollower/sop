...
public class ClientGradeServiceImpl implements ClientGradeService {
	private static Logger LOG = Logger.getLogger(ClientGradeServiceImpl.class);
	@Autowired
	private ClientGradeDao clientGradeDao;

	@Override
	public OaMsg getClientGrade() throws OAException {
		OaMsg oaMsg = new OaMsg();
		try {
			oaMsg.setCode(Constant.SYS_CODE_SUCCESS);
			oaMsg.getData().addAll(clientGradeDao.getClientGradeList());

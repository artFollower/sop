...
@Repository
public class OfficeGradeDaoImpl extends BaseDaoImpl implements OfficeGradeDao {
	private static Logger LOG = Logger.getLogger(OfficeGradeDaoImpl.class);
	@Override
	public List<Map<String, Object>> getTaxTypeList() throws OAException {
		try {
			String sql="select * from t_pcs_office_grade";

...
!function(t, i, e) {
	...
	s.prototype = {
		...
		place: function() {
			if (!this.isInline) {
				...
				"auto" !== this.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (u -= e - l)) : (this.$widget.addClass("timepicker-orient-left"), d.left < 0 ? u -= d.left - n: d.left + e > h && (u = h - e - n));
				var m, g, f = this.orientation.y;
				"auto" === f && (m = -a + d.top - s, g = a + o - (d.top + c + s), f = Math.max(m, g) === g ? "top": "bottom"),
				this.$widget.addClass("timepicker-orient-" + f),
				"top" === f ? p += c: p -= s + parseInt(this.$widget.css("padding-top"), 10),
				this.$widget.css({
					top: p,
					left: u,
					zIndex: r
		...
		setDefaultTime: function(t) {
			if (this.$element.val()) this.updateFromElementVal();
				...
				n = i.getSeconds(),
				h = "AM";
				0 !== n && (n = Math.ceil(i.getSeconds() / this.secondStep) * this.secondStep, 60 === n && (s += 1, n = 0)),
				0 !== s && (s = Math.ceil(i.getMinutes() / this.minuteStep) * this.minuteStep, 60 === s && (e += 1, s = 0)),
				this.showMeridian && (0 === e ? e = 12 : e >= 12 ? (e > 12 && (e -= 12), h = "PM") : h = "AM"),
				this.hour = e,
				this.minute = s,
				this.second = n,
				this.meridian = h,
		...
		widgetKeyup: function(t) { (65 === t.keyCode || 77 === t.keyCode || 80 === t.keyCode || 46 === t.keyCode || 8 === t.keyCode || t.keyCode >= 46 && t.keyCode <= 57) && this.updateFromWidgetInputs()
		}
	},
	t.fn.timepicker = function(i) {
		...
		this.each(function() {
			...
			h = n.data("timepicker"),
			o = "object" == typeof i && i;
			h || n.data("timepicker", h = new s(this, t.extend({},

	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">车位信息</h4>
			</div>
			<div class="modal-body" style="padding-left:45px; padding-right:65px;">
			     <form action="#" class="form-horizontal">
                     <div class="form-body">
                       <div class="form-group">
                       <label class="col-md-4 control-label">车位名<span class="required">*</span></label>
                       <div class="col-md-8">
                      ...
                      <div class="form-group">
                       <label class="col-md-4 control-label">关联泵号:</label>
                       <div class="col-md-8">
                       <input class="form-control" maxlength="10" data-type="Require" id="pumpName">
                       </div>
                       </div> 	     
                      <div class="form-group">
                       <label class="col-md-4 control-label">前期存储物料:</label>
                       <div class="col-md-8">
                       <input class="form-control" maxlength="10" data-type="Require" id="productId">
                       </div>
                       </div> 
                       <div class="form-group">

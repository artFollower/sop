			...
			<form action="#" class="form-horizontal contract-add-form">
				<div class="form-body">
					...
					<td class=" col-md-6">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" maxlength="16" readonly name="code" data-required="1" data-type="Require" class="form-control code" />
									</div>
								</div>
							</td>
					</tr>
						<tr>
							<td class=" col-md-6">
								<div class="form-group">
									...
									<input id="intention"  type="text" data-provide="typeahead"  class="form-control intention">
									</div>
								</div>
							</td>
							<td class=" col-md-6">
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="name" maxlength="32" data-required="1" data-type="Require" class="form-control orderTitle" />
									</div>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td class=" col-md-6">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" maxlength="8" class="form-control overtimePrice" name="overtimePrice" onkeyup="config.clearNoNum(this,2)" onafterpaste="config.clearNoNum(this)" />
									</div>
								</div>
							</td>
							<td class=" col-md-6">
						...
						<tr>
							<td class=" col-md-6">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" maxlength="8" class="form-control lossRate" name="lossRate" onkeyup="config.clearNoNum(this)" onafterpaste="config.clearNoNum(this)" />
									</div>
								</div>
							</td>
							<td class=" col-md-6">
								<div class="form-group">
									<label class="control-label col-md-5">合同总价<span class="required">*</span></label>
									<div class="col-md-7">
				...
				<div class="modal-footer">
					<div class="col-md-offset-3 col-md-9">
						...
						<a href="javascript:void(0)" onclick="Contract.doChange1(0)" class="btn btn-primary saveButton">保存</a>
						<!-- <button type="button" onclick="Contract.doAdd(1)" class="btn btn-primary submitButton">提交</button> -->
						</shiro:hasPermission>
					</div>
				</div>
			</form>

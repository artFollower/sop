...
<body>
	...
	<div class="col-md-12">
		...
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-list-alt"></i><!-- 车发流量计月度汇总表 -->月度汇总表
			</div>
		</div>
			<div>
				...
				<div id="roleManagerQueryDivId" hidden="true">
					<div class="row">
					<div class="form-body productMonthlyStatement">
						<div class="form-group parkDailyStatement" >
						<label class="control-label col-md-1">货品</label>
						<div class="col-md-2">
								<input class="form-control" id="productId" style="width:180px;" type="text"	placeholder="货品">
						</div>
			...
			<div data-role="productMonthlyStatement">
			</div>
		</div>
		</div>
	</div>

...
<head>
  ...
  Fonts END -->
  <!-- Global styles BEGIN -->
  <link href="<%=basePath %>/resource/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<%=basePath %>/resource/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="<%=basePath %>/resource/global/plugins/slider-revolution-slider/rs-plugin/css/settings.css" rel="stylesheet">
  <!-- Global styles END -->
  <!-- Page level plugin styles BEGIN -->
  <link href="<%=basePath %>/resource/global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet">
  <!-- Page level plugin styles END -->
  <!-- Theme styles BEGIN -->
  <link href="<%=basePath %>/resource/global/css/components.css" rel="stylesheet">
  <link href="<%=basePath %>/resource/frontend/onepage/css/style.css" rel="stylesheet">
  <link href="<%=basePath %>/resource/frontend/onepage/css/style-responsive.css" rel="stylesheet">
  <link href="<%=basePath %>/resource/frontend/onepage/css/themes/red.css" rel="stylesheet" id="style-color">
  <link href="<%=basePath %>/resource/frontend/onepage/css/custom.css" rel="stylesheet">
  <!-- Theme styles END -->
</head>
...
<body class="menu-always-on-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2">
          <a class="scroll site-logo" href="#promo-block"><img src="<%=basePath %>/resource/frontend/onepage/img/logo/red.png" alt="Metronic One Page"></a>
        </div>
        <!-- Logo END -->
        ...
        <div class="col-md-9">
          <ul class="header-navigation">
            ...
            <li><a href="#about">管理理念</a></li>
            <li><a href="#services">地理环境</a></li>
            <li><a href="#team">码头设施</a></li>
            <li><a href="#portfolio">罐区设施</a></li>
            <li><a href="#benefits">领导视察</a></li>
            <!-- <li><a href="#prices">报价</a></li> -->
            <li><a href="#contact">联系我们</a></li>
            <!-- <li><a href="<%=basePath %>" class="btn btn-circle btn-default">登录</a></li> -->
          </ul>
        </div>
        <div class="col-md-1 col-sm-2">
        
			<shiro:notAuthenticated>        
        		<a href="<%=basePath %>/login" class="site-logo">登录</a>
       		</shiro:notAuthenticated>
       		<shiro:authenticated>
       			<a href="<%=basePath %>/home" class="site-logo">控制台</a>
       		</shiro:authenticated>
        </div>
        <!-- Navigation END -->
      </div>
      ...
      <div class="tp-banner" >
        <ul>
          <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-1">
            <img src="<%=basePath %>/resource/frontend/onepage/img/silder/slide1.jpg" alt="" data-bgfit="cover" style="opacity:0.4 !important;" data-bgposition="center center" data-bgrepeat="no-repeat">
            <div class="tp-caption large_text customin customout start"
              ...
              <div class="promo-like-text">
                <h2>长江石油化工有限公司</h2>
                <p>优质的服务,优良的品质 <br> <a href="<%=basePath %>/login">登录</a></p>
              </div>
            </div>
            <div class="tp-caption large_bold_white fade"
              ...
              style="z-index: 6">网上 <span>服务平台</span>正式开放
            </div>
          </li>
          <li data-transition="fadefromright" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-2">
            <img src="<%=basePath %>/resource/frontend/onepage/img/silder/Slide2_bg.jpg" alt="slidebg2" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
            <div class="caption lft start"
              ...
              data-speed="600" 
              data-start="500" 
              data-easing="easeOutBack"><img src="<%=basePath %>/resource/frontend/onepage/img/silder/Slide2_iphone_left.png" alt="">
            </div>
            <div class="caption lft start"
              data-y="center"
              data-voffset="130"
              ...
              data-speed="600" 
              data-start="1200" 
              data-easing="easeOutBack"><img src="<%=basePath %>/resource/frontend/onepage/img/silder/Slide2_iphone_right.png" alt="">
            </div>
            <div class="tp-caption large_bold_white fade"
              data-x="center"
              data-y="40"
              ...
              data-endeasing="Power1.easeIn"
              data-captionhidden="off"
              style="z-index: 6">多种 <span>移动设备</span> 的支持
            </div>
          </li>
          <!-- 
          <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-3">
            ...
            <div class="tp-caption tp-fade fadeout fullscreenvideo"
              ...
              <video class="video-js vjs-default-skin" preload="none" width="100%" height="100%">
                <source src='https://www.dropbox.com/s/6t2y0xx2x6wos06/Show1.mp4' type='video/mp4'>
              </video>
            </div>
  ...
  <div class="about-block content content-center" id="about">
    <div class="container">
      ...
      <div class="ab-trio">
        <img src="<%=basePath %>/resource/frontend/onepage/img/trio.png" alt="" class="img-responsive">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 item">
          <img src="<%=basePath %>/resource/frontend/onepage/img/people/img6-large.jpg" alt="Marcus Doe" class="img-responsive">
          <h3>Marcus Doe</h3>
          <em>Founder</em>
        ...
        <div class="col-md-4 item">
          <img src="<%=basePath %>/resource/frontend/onepage/img/people/img7-large.jpg" alt="Elena Taylor" class="img-responsive">
          <h3>Elena Taylor</h3>
          <em>Designer</em>
          <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
          <div class="tb-socio">
        ...
        <div class="col-md-4 item">
          <img src="<%=basePath %>/resource/frontend/onepage/img/people/img8-large.jpg" alt="Cris Nilson" class="img-responsive">
          <h3>Cris Nilson</h3>
          <em>Developer</em>
          <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
          <div class="tb-socio">
  ...
  <div class="portfolio-block content content-center" id="portfolio">
    ...
    <div class="row">
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/2.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/2.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/6.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/6.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/8.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/8.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/3.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/3.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/5.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/5.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/4.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/4.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/1.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/1.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/10.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/10.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/9.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/9.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="<%=basePath %>/resource/frontend/onepage/img/portfolio/7.jpg" alt="NAME" class="img-responsive">
        <a href="<%=basePath %>/resource/frontend/onepage/img/portfolio/7.jpg" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 text-left">
          <img src="<%=basePath %>/resource/frontend/onepage/img/choose-us.png" alt="Why to choose us" class="img-responsive">
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12 text-left">
      ...
      <div class="carousel slide" data-ride="carousel" id="testimonials-block">
        ...
        <div class="carousel-inner">
          ...
          <div class="active item">
            <blockquote>
              <p>This is the most awesome, full featured, easy, costomizeble theme. Itâs extremely responsive and very helpful to all suggestions.</p>
            </blockquote>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/cisco.png" alt="cisco">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/walmart.png" alt="walmart">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/gamescast.png" alt="gamescast">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/spinwokrx.png" alt="spinwokrx">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/ngreen.png" alt="ngreen">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="<%=basePath %>/resource/frontend/onepage/img/partners/vimeo.png" alt="vimeo">
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="<%=basePath %>/resource/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
  <script src="<%=basePath %>/resource/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
  <script src="<%=basePath %>/resource/frontend/onepage/scripts/revo-ini.js" type="text/javascript"></script> 
  <!-- END RevolutionSlider -->
  <!-- Core plugins BEGIN (required only for current page) -->
  <script src="<%=basePath %>/resource/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script><!-- pop up -->
  <script src="<%=basePath %>/resource/global/plugins/jquery.easing.js"></script>
  <script src="<%=basePath %>/resource/global/plugins/jquery.parallax.js"></script>
  <script src="<%=basePath %>/resource/global/plugins/jquery.scrollTo.min.js"></script>
  <script src="<%=basePath %>/resource/frontend/onepage/scripts/jquery.nav.js"></script>
  <!-- Core plugins END (required only for current page) -->
  <!-- Global js BEGIN -->
  <script src="<%=basePath %>/resource/frontend/onepage/scripts/layout.js" type="text/javascript"></script>
  <script>

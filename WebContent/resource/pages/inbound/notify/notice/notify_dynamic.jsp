		...
		<div class="tools">
			<shiro:hasPermission name="ANOTICEDYNAMICEXEL">
				<a class="hidden-print" style="color: white;"
					onclick="notify.exportXML(this,27)"> <i
					...
					<tr>
						<td colspan="2"><h5>
								&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);"
									onclick="notify.dialogShowLog(this,2)"><i
									class="fa fa-file-text-o"></i></a> &nbsp;<a
									href="javascript:void(0);" onclick="notify.saveLog(this,2)" id="saveRequire"><i
									class="fa fa-floppy-o"></i></a>
							</h5></td>
					</tr>
					<tr>
						<td class="col-md-12"><textarea
								class="form-control assignwork" maxlength="150" rows="2"
								...
								<div class="modal-footer sureDiv isModify">
									<div class="col-md-8 form-horizontal isNoModify">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" id="sureTaskUserId" class="form-control"
										...
										<div class="aDiv" style="float: right;">
											<shiro:hasPermission name="ANOTICEDISPATCHANDDYNAMIC">
												<button style="padding: 3px 8px;" type="button" key="1"
													class="btn btn-primary isModify spBtn" id="aSureBtn">确认</button>
											</shiro:hasPermission>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="j" id="j3" value="option2"> 不适用
										</label>
									</div>
								</div>
							</td>

...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="tools">
			<shiro:hasPermission name="ANOTICEDOCKTUBECLEANEXEL">
				<a class="hidden-print" style="color: white;"
					onclick="notify.exportXML(this,17)"> <i
				...
				<table width="100%">
							...
							<div class="col-md-12 form-group">
								<div class="col-md-6">
									...
									<div class="col-md-8 tubeId">
										<input class="form-control" maxlength="16" id="tubeId">
									</div>
								</div>
								<div class="col-md-6">
					...
					<tr>
						<td class="col-md-12">
							...
							<!-- <div class="col-md-12">
								<button type="button" class="btn btn-default btn-circle mar-r-10 btn-add" onclick="config.flowAreaINput()">→</button>
							</div>
							<div class="col-md-12">
								<textarea class="form-control area-input" maxlength="150" rows="3"></textarea>
							</div> -->
						</td>
					</tr>
					<tr>
						<td colspan="2"><h5>
								&nbsp;二、作业要求:&nbsp;<a href="javascript:void(0);"
									onclick="notify.dialogShowLog(this,5)"><i
									class="fa fa-file-text-o"></i></a> &nbsp;<a
									href="javascript:void(0);" onclick="notify.saveLog(this,5)"><i
					...
					<div class="form-body">
						<table width="100%"
							...
							<tr>
								...
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;氮气泄漏、物料飞溅</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;作业前做好扫线管的连接</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">4、阀门丝杆处物料泄漏</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;污染环境</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;做好检查、及时封堵</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">5、管线腐蚀造成物料泄漏</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;污染环境</h6></td>
							...
							<tr>
								...
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;严格执行调度命令，调度做好确认工作</h6></td>
							</tr>
							<tr>
			...
			<div class="portlet-body">
				<div class="form-body">
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											name="d" id="d2" value="option2"> 否 </label> <label
											class="checkbox-inline"><input type="checkbox"
											name="d" id="d3" value="option3"> 不适合 </label>
									</div>
								</div>
							</td>
						</tr>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="e" id="e3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="f" id="f3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="g" id="g3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
					...
					<div class="modal-footer isModify beforeDiv">
						<shiro:hasPermission name="ANOTICEDODOCKTUBECLEAN">
							<div class="col-md-8 form-horizontal isNoModify">
								<div class="form-group">
						...
						<shiro:hasPermission name="ANOTICEDISPATCHANDDOCKTUBECLEAN">
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="h" id="h3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="i" id="i3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="k" id="k3" value="option2"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="l" id="l3" value="option2"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="m" id="m3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" name="p" id="p3" value="option3"> 不适合
										</label>
									</div>
								</div>
							</td>

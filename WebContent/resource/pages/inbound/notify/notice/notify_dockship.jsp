		...
		<div class="tools">
			<shiro:hasPermission name="ANOTICEDOCKSHIPEXEL">
				<a class="hidden-print" style="color: white;"
					onclick="notify.exportXML(this,29)"> <i
						...
						<td colspan="2">
							<h5>
								&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);"
									onclick="notify.dialogShowLog(this,11)"><i
									class="fa fa-file-text-o"></i></a>&nbsp;<a
									id="saveRequire" onclick="notify.saveLog(this,11)"
									href="javascript:void(0);" title="保存"><i
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="b" id="b1" value="b"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="b" id="b2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="c" id="c1" value="c"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="c" id="c2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="d" id="d1" value="d"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="d" id="d2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="e" id="e1" value="e"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="e" id="e2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="f" id="f1" value="f"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="f" id="f2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="g" id="g1" value="g"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="g" id="g2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="j" id="j1" value="a"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="j" id="j2" value="2"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="k" id="k1" value="b"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="k" id="k2" value="4"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="l" id="l1" value="c"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="l" id="l2" value="6"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="m" id="m1" value="d"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="m" id="m2" value="6"> 否
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td class="col-md-4">
								<div class="form-group">
									<div class="checkbox-list">
										<label class="checkbox-inline"> <input type="checkbox"
											name="o" id="o1" value="b"> 是
										</label> <label class="checkbox-inline"> <input
											type="checkbox" name="o" id="o2" value=""> 否
										</label>
									</div>
								</div>
							</td>

...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="tools">
			<shiro:hasPermission name="ANOTICETANKCLEANEXEL">
				<a class="hidden-print" style="color: white;"
					onclick="notify.exportXML(this,21)"> <i
		...
		<form action="#" class="form-horizontal form-bordered">
			<div class="form-body">
				<table width="100%">
							...
							<div class="col-md-12 form-group">
								<div class="col-md-3"
									...
									<label class="col-md-4 control-label"
										style="padding-left: 0px;">罐号:</label>
									<div class="col-md-8"
										style="padding-right: 0px; padding-left: 0px;">
								...
								<div class="col-md-3"
									...
									<label class="col-md-6 control-label"
										style="padding-left: 0px;">物料名称:</label>
									<div class="col-md-6"
										style="padding-right: 0px; padding-left: 0px;">
								...
								<div class="col-md-3"
									style="padding-right: 0px; padding-left: 0px;">
									<label class="col-md-4 control-label"
										style="padding-left: 0px;">数量:</label>
									<div class="col-md-8"
										style="padding-right: 0px; padding-left: 0px;">
										<input onkeyup="config.clearNoNum(this)" maxlength="16"
											class="form-control" id="goodsNum">
									</div>
								</div>
								<div class="col-md-3"
									style="padding-right: 0px; padding-left: 0px;">
									<label class="col-md-4 control-label"
										style="padding-left: 0px;">泵号:</label>
									<div class="col-md-8"
										style="padding-right: 0px; padding-left: 0px;">
										<input class="form-control" maxlength="16" id="pupmId">
									</div>
								</div>
							</div>
						</td>
					...
					<tr>
						<td colspan="2"><h5>&nbsp;一、作业工艺流程:</h5></td>
					</tr>
					<tr>
						<td class="col-md-12">
							<div id="toolbarContainer"
								style="overflow: hidden; width: 100px; height: 22px; z-index: 999; border: 1px solid #d8d8d8; border-radius: 3px;"></div>
							<div id="contentDiv" class="content"
								style="border: 1px solid #d8d8d8; border-radius: 3px; float: left; height: 60px; width: 625px;">
								<div id="graphContainer"
									style="overflow: hidden; width: 625px; height: 60px; margin-top: 0px;"></div>
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="2"><h5>
								&nbsp;二、作业要求:&nbsp;<a href="javascript:void(0);"
									onclick="notify.dialogShowLog(this,9)"><i
									class="fa fa-file-text-o"></i></a> &nbsp;<a
									href="javascript:void(0);" onclick="notify.saveLog(this,9)"><i
					...
					<tr>
						<td colspan="2"><h5>
								&nbsp;三、注意事项:&nbsp;<a href="javascript:void(0)"
					...
					<tr>
						<td colspan="2" class="dialog-warning1"><h6>
								<p>&nbsp;&nbsp;1、罐区污水阀开启并确认罐区雨水阀关闭;</p>
								<p>&nbsp;&nbsp;2、相关管线物料已吹尽,低位已放尽并且与罐体已经脱开;</p>
								<p>&nbsp;&nbsp;3、正确佩戴个人防护用品;</p>
								<p>&nbsp;&nbsp;4、使用防爆工具;</p>
								<p>&nbsp;&nbsp;5、清罐清除的垃圾必须放入危险固体废物箱内;</p>
								<p>&nbsp;&nbsp;6、作业过程中按规定做好罐内有毒气体的检测工作;</p>
								<p>&nbsp;&nbsp;7、作业过程中必须安排好监护人员;</p>
							</h6></td>
					</tr>
				</table>
			</div>
				...
				<form action="#" class="form-horizontal">
					<div class="form-body">
						<table width="100%"
							...
							<tr>
								<td class="col-md-4"><h6 style="text-align: center">危害及潜在事件</h6></td>
								<td class="col-md-4"><h6 style="text-align: center">主要后果</h6></td>
								<td class="col-md-4"><h6 style="text-align: center">安全措施</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">1、未正确佩戴个人防护用品</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;人身伤害</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;严格按照规定佩戴个人防护用品</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">2、雨水阀门未及时关闭造成污水外排</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;造成水体污染</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;严格执行规定,关闭雨水阀门</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">3、人体静电未释放</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;产生静电,可能导致火灾</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;进入作业场所前释放人体静电</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">4、使用非防爆工具,产生火花</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;火灾爆炸</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;使用防爆工具</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">5、管线未与罐体脱开,物料进入罐内</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;人身伤害</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;清罐前确认管线与罐体断开</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">6、未对储罐进行有毒气体检测</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;人身伤害</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;作业前严格按规定办理手续、做好检测</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">7、作业前未将氮封装置和储罐脱开</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;人员窒息</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;作业前将氮封装置和储罐脱开</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">8、未对储罐进行可燃气体检测</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;爆炸</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;作业前严格按规定办理手续、做好检测</h6></td>
							</tr>
							<tr>
								<td class="col-md-4"><h6 style="text-align: left">9、照明没有接安全电压造成漏电</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;人身伤害</h6></td>
								<td class="col-md-4"><h6 style="text-align: left">&nbsp;按规定接安全电压</h6></td>
							</tr>
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<div class="modal-footer isModify beforeDiv">
						<shiro:hasPermission name="ANOTICEDOTANKCLEAN">
							<div class="col-md-8 form-horizontal isNoModify">
								<div class="form-group">
						...
						<shiro:hasPermission name="ANOTICEDISPATCHANDTANKCLEAN">

		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title">&nbsp;操作班船发作业通知单</h5>
				</div>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<shiro:hasPermission name="ANOTICEDYNAMICSHIPEXEL">
								<a class="hidden-print" style="color: white;" onclick="notify.exportXML(this,30)"> <i class="fa fa-file-excel-o">&nbsp;导出</i>
								</a>
								</shiro:hasPermission>
							</div>
						</div>
							...
							<form action="#" class="form-horizontal form-bordered">
								<div class="form-body">
									<table width="100%">
										...
										<tr>
											<td colspan="2"><h5>
													&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);" onclick="notify.dialogShowLog(this,12)"><i class="fa fa-file-text-o"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="saveRequire" href="javascript:void(0);" onclick="notify.saveLog(this,12)" title="保存"><i class="fa fa-floppy-o"></i></a>
												</h5></td>
										</tr>
										<tr>
											<td class="col-md-12">
									...
									<form action="#" class="form-horizontal">
										<div class="form-body">
											<table width="100%" class="table table-condensed table-striped table-bordered notice-table">
												...
												<tr>
													<td class="col-md-4"><h6 class="form-section " style="text-align: left">1、个人防护用品不适用或未正确佩戴</h6></td>
							...
							<div class="portlet box white notice-check" hidden="true">
								...
								<div class="portlet-body">
									...
									<div class="form-body">
										...
										name="in" id="inCheckAll"><i class="fa fa-square-o"></i></a></h6></td>
											</tr>
											<tr>
												<td class="col-md-8">
									...
									<div class="form-body">
										...
										name="after" id="afterCheckAll"><i class="fa fa-square-o"></i></a></h6></td>
											</tr>
											<tr>
												<td class="col-md-8">
													<h6>1、泵是否停止</h6>
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														<div class="checkbox-list">
															<label class="checkbox-inline"> <input type="checkbox"  name="q" id="q1" value="option2"> 是
															</label> <label class="checkbox-inline"> <input type="checkbox" name="q" id="q2" value="option2"> 否
															</label>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														<div class="checkbox-list">
															<label class="checkbox-inline"> <input type="checkbox"  name="r" id="r1" value="option2"> 是
															</label> <label class="checkbox-inline"> <input type="checkbox" name="r" id="r2" value="option2"> 否
															</label>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														<div class="checkbox-list">
															<label class="checkbox-inline"> <input type="checkbox"  name="s" id="s1" value="option1"> 是
															</label> <label class="checkbox-inline"> <input type="checkbox" name="s" id="s2" value="option2"> 否
															</label>
														</div>
													</div>
												</td>

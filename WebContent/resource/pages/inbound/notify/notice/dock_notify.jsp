	...
	<div class="modal-dialog notice">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title">&nbsp;码头接卸作业通知单</h5>
			</div>
				...
				<div class="portlet box blue">
					...
					<div class="tools">
					 <shiro:hasPermission name="ANOTICEDOCKEXEL">
								<a class="hidden-print" style="color: white;" onclick="notify.exportXML(this,26)"> <i class="fa fa-file-excel-o">&nbsp;导出</i>
								</a>
								</shiro:hasPermission>
							</div>
						<!-- <div class="tools">
						...
						<form action="#" class="form-horizontal form-bordered">
							...
							<label class="control-label hidden" id="transportId"></label>
								<table width="100%">
									...
									<tr>
										<td class="col-md-12 ">
											<div  id="contentDiv" style="border: 1px solid #d8d8d8;position: relative;  cursor: move; width: 631px; height: 350px;"></div>
										</td>
									</tr>
									<tr>
										<td colspan="2">
											<h5>
												&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);" onclick="notify.dialogShowLog(this,1)"><i class="fa fa-file-text-o"></i></a>
												&nbsp;<a href="javascript:void(0);"onclick="notify.saveLog(this,1)"><i class="fa fa-floppy-o"></i></a>
											</h5>
										</td>
									</tr>
									<tr>
										<td class="col-md-12">
											<div class="col-md-12" style="padding-left:0px;padding-right:0px;">
												<textarea class="form-control  assignwork" rows="2" maxlength="150" id="taskRequire"></textarea>
											</div>
										</td>
									</tr>
									<tr><td colspan="2">
							...
							<div class="portlet-body">
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														...
														<Button style="padding:3px 8px;" key="1" class="btn btn-primary isModify spBtn" id="lSureBtn">确认</Button>
														</shiro:hasPermission>
														</div>
													</div>
												</div>
								...
								<div class="form-body">
									...
									<div class="col-md-8 form-horizontal isNoModify">
									   ...
									   <shiro:hasPermission name="ANOTICEDODOCK">
										<button type="button" class="btn isNoModify btn-primary" key="2" status="1" id="submitInTask">确认</button>
										</shiro:hasPermission>
									</div>
								</div>
								<div class="form-body">
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														...
														</label><label class="checkbox-inline"> <input type="checkbox" name="s" id="s3" value=""> 不适用
														</label>
														<div class="sDiv" style="float:right;">
														<shiro:hasPermission name="ANOTICEDISPATCHANDDOCK">
														<button style="padding:3px 8px;" type="button" key="3" class="btn isModify btn-primary spBtn" id="sSureBtn">确认</button>
														</shiro:hasPermission>
														</div>
													</div>
												</div>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														...
														<shiro:hasPermission name="ANOTICEDISPATCHANDDOCK">
														<button style="padding:3px 8px;" type="button" key="3" class="btn btn-primary isModify spBtn" id="tSureBtn">确认</button>
														</shiro:hasPermission>
														</div>
													</div>
												</div>

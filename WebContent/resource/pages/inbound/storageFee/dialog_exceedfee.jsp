	...
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<form action="#" class="form-horizontal">
                     <div class="form-body">
                      ...
                      <label class="col-md-8 hidden feeKey" id="exceedType"></label>
                       ...
                       <label class="col-md-4 control-label">上家单位:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="sendClientName"></label>
                       ...
                       <label class="col-md-4 control-label">提单号:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="ladingCode"></label>
                       </div>
                       <div class="col-md-6">
                       <label class="col-md-4 control-label">货品名称:</label>
                        ...
                        <div class="col-md-6 ladingDiv">
                       <label class="col-md-4 control-label">货批号:</label>
                        <label class="col-md-8 control-label " style="text-align:left" id="ladingCargoCode"></label>
                       </div>
                        </div>
                       <div class="form-group">
                       <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-8 " >
                        <input class="form-control unitFee" onkeyup="config.clearNoNum(this,2)" id="exceedFee" >
                        </div>
                       </div>
                      ...
                      <div class="scroller " style="height:210px;overflow-y:scroll;">
                       ...
                       <div class="form-group" style="margin-top:35px;">
                          ...
                          <div class="col-md-9">
                          <textarea class="form-control" rows="3" maxlength="300" id="description"></textarea>
                          </div>
                       </div> 
			...
			<div class="modal-footer controlDiv">
				...
				<button type="button" class="btn btn-primary finishFee" style="display:none;">结清</button>

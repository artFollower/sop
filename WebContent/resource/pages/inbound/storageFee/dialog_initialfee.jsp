	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">江苏长江石油化工有限公司储品首期费结算清单</h4>
			</div>
			...
			<div class="input-group col-md-12">
				...
				<label class="hidden initialType">1</label>
			    </div>
                     ...
                     <div class="form-body">
                      ...
                      <label class="col-md-8 hidden feeKey" id="id"></label>
                       ...
                       <label class="col-md-4 control-label">货批号:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="cargoCode"></label>
                       </div>
                       <div class="col-md-6">
                        <label class="col-md-4 control-label">商检数:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="goodsInspect"></label>
                       </div>
                       </div> 
                       <div class="form-group">
                        <div class="col-md-6">
                       ...
                       <label class="col-md-4 control-label">船舶中文名:</label>
                        ...
                        <div class="form-group">
                        <div class="col-md-6">
                        <label class="col-md-4 control-label">船舶性质:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="shipType"></label>
                        </div>
                       <div class="col-md-6">
                       <label class="col-md-4 control-label">入库日期:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="arrivalTime"></label>
                       </div>
                       </div> 
                       <div class="form-group">
                       <div class="col-md-6">
                         <label class="col-md-4 control-label">合同号:</label>
                        <label class="col-md-8 control-label feeKey" style="text-align:left" id="contractCode"></label>
                        </div>
                        <div class="col-md-6">
                         <label class="col-md-4 control-label">合同类型:</label>
                        <label class="col-md-8 control-label " style="text-align:left" id="contractType"></label>
                        </div>
                       </div>     
                       <div class="form-group periodTimeDiv">
                       <div class="col-md-12">
                          <label class="col-md-2 control-label">周期:</label>
                        <label class="col-md-10 control-label" style="text-align:left" id="periodTime"></label>
                        </div>
                       </div>    

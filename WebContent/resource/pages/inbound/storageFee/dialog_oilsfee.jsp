	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">江苏长江石油化工有限公司出库结算清单</h4>
			</div>
			...
			<div class="input-group col-md-12 accountTime">
				...
				<label class="hidden initialType">3</label>
			    </div>
				...
				<form action="#" class="form-horizontal">
                     <div class="form-body">
                      ...
                      <label class="col-md-8 hidden feeKey" id="id"></label>
                       ...
                       <div class="col-md-8">
                       <input class="form-control feeKey" onkeyup="config.clearNoNum(this)" maxlength="16" style="text-align:left" id="goodsTotal">
                       </div>
                       </div>
                       </div>   
                       <div class="form-group">
                       <div class="col-md-8">
                          <label class="col-md-3 control-label">时间区间<a href="javascript:void(0)" 
						...
						<div class="input-group date-picker input-daterange"
							...
							<input type="text" class="form-control" name="endTime" 
                               ...
                               <button type="button" class="btn btn-primary " id="checkOutBoundList">确认</button>
                        </div>
						</div>
					</div>
                        </div> 

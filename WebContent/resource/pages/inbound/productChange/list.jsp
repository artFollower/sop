...
<body>
	...
	<div class="col-md-12">
		...
		<div class="portlet">
			...
			<div>
				...
				<table border="0" cellspacing="0" cellpadding="0">
				  <tr>
				      ...
				      <td style="vertical-align: bottom;"><button onclick="ProductChange.search()" type="button" style="position:relative; margin-left:35px; top: -15px" class="btn btn-success"><span class="glyphicon glyphicon-search"></span>&nbsp;</button></td>
				  </tr>
				</table>	
				</div>
				</form>
			...
			<shiro:hasPermission name="AADDCHANGEPROCARGO">
				<button class="btn btn-default btn-circle mar-r-10 btn-modify" type="button"  onclick="ProductChange.doOpen()" >
						<span class="fa fa-plus"></span><span class="pad-l-5">添加品名更换</span>
					</button>

...
<link href="<%=basePath %>/resource/admin/layout/css/inboundPrintmb.css" rel="stylesheet" type="text/css" media="print" />
...
<img src="<%=basePath %>/resource/admin/layout/img/bg_yz.png" alt="logo" />
				...
				<table class="printS" style=" width: 100%;font-size: 13px;line-height: 25px " border='0'  cellspacing='0'  align='center'>
				 ...
				 <tr>
				    <td type="col-6" >
							...
							<td  type="col-6"  >
								<div >
									<label type="col-8" id="arrivalTime">  </label>
								</div>
							</td>

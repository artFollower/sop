				...
				<label class="col-md-3 control-label" key="0" style="text-align:left" id="code"></label> -->
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="tools">
								<a class="hidden-print" style="color: white;" onclick="InboundOperation.exportXML(this,13)"> <i class="fa fa-file-excel-o">&nbsp;导出</i>
								</a>
							</div>
						<!-- <div class="tools">
										...
										<tr>
											<td colspan="2">
												<div class="modal-footer sureDiv">
													...
													<button type="button" class="btn btn-success" key="15"
														status="0" id="saveSureTask">保存</button>
													<button type="button" class="btn btn-primary" key="15"
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														...
														<button style="padding:3px 8px;" type="button" key="16" class="btn btn-primary spBtn" id="dSureBtn">确认</button>
														</div>
														</div>
													</div>
												</td>
									...
									<div class="col-md-12 beforecheck">
									   ...
									   <label class="col-md-4 control-label">工作人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text"  id="beforeTaskUserId" class="form-control" readonly data-required="1" />
										  ...
										  <button type="button" class="btn btn-success" key="16" status="0" id="saveBeforeTask">保存</button>
										<button type="button" class="btn btn-primary" key="16" status="1" id="submitBeforeTask">确认</button>
										</div>
									</div>
									<div class="form-body">
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														...
														<button style="padding:3px 8px;" type="button" key="17" class="btn btn-primary spBtn" id="eSureBtn">确认</button>
														</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														...
														<button style="padding:3px 8px;" type="button" key="17" class="btn btn-primary spBtn" id="fSureBtn">确认</button>
														</div>
														</div>
													</div>
												</td>
									...
									<div class="col-md-12 incheck">
									   ...
									   <label class="col-md-4 control-label">工作人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text"  id="inTaskUserId" class="form-control" readonly data-required="1"/>
											...
											<button type="button" class="btn btn-success" key="17" status="0" id="saveInTask">保存</button>
										<button type="button" class="btn btn-primary" key="17" status="1" id="submitInTask">确认</button>
										</div>
									</div>
									<div class="form-body">
									...
									<div class="col-md-12 aftercheck">
									   ...
									   <label class="col-md-4 control-label">工作人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text" id="afterTaskUserId" class="form-control" readonly data-required="1" />
											...
											<button type="button" class="btn btn-success" key="18" status="0" id="saveAfterTask">保存</button>
										<button type="button" class="btn btn-primary" key="18" status="1" id="submitAfterTask">确认</button>
										</div>
									</div>
								</div>
							</div>

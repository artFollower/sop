		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title">&nbsp;接卸作业通知单(动力班)</h5>
				</div>
				...
				<label class="col-md-3 control-label" key="0" style="text-align:left" id="code"></label> -->
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="tools">
								<a class="hidden-print" style="color: white;" onclick="InboundOperation.exportXML(this,12)"> <i class="fa fa-file-excel-o">&nbsp;导出</i>
								</a>
							</div>
						<!-- <div class="tools">
							...
							<form action="#" class="form-horizontal form-bordered">
								<div class="form-body">
									<table width="100%">
										...
										<tr>
											<td class="col-md-12">
													<textarea class="form-control" rows="3" id="dynamictaskmsg"></textarea>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="col-md-12">
													<div id="contentDiv" class="content" style="border: 1px solid #d8d8d8;position: relative; overflow: auto; cursor: move; width: 631px; height: 350px;">
													</div>
											</td>
										</tr>
										<tr>
											<td colspan="2"><h5>
													&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);" onclick="InboundOperation.dialogShowMsg(2)"><i class="fa fa-file-text-o"></i></a>
									...
									<button type="button" class="btn btn-success" key="11" flag="0" id="saveSureTask">保存</button>
										<button type="button" class="btn btn-primary" key="11" flag="1" id="submitSureTask">确认</button>
									</div>
									</td></tr>
										<tr>
											<td colspan="2"><h5>
											...
											<tr>
												...
												<td class="col-md-4">
													<div class="form-group">
														...
														<button style="padding:3px 8px;" type="button" key="12" class="btn btn-primary spBtn" id="aSureBtn">确认</button>
														</div>
														</div>
													</div>
												</td>
									...
									<div class="col-md-12 beforecheck">
									   ...
									   <label class="col-md-4 control-label">作业人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text"  id="beforeTaskUserId" class="form-control" readonly data-required="1" />
										  ...
										  <button type="button" class="btn btn-success" key="12" flag="0" id="saveBeforeTask">保存</button>
										<button type="button" class="btn btn-primary" key="12" flag="1" id="submitBeforeTask">确认</button>
										</div>
									</div>
									<div class="form-body">
									...
									<div class="col-md-12 incheck">
									   ...
									   <label class="col-md-4 control-label">作业人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text"  id="inTaskUserId" class="form-control" readonly data-required="1"/>
											...
											<button type="button" class="btn btn-success" key="13" flag="0" id="saveInTask">保存</button>
										<button type="button" class="btn btn-primary" key="13" flag="1" id="submitInTask">确认</button>
										</div>
									</div>
									<div class="form-body">
									...
									<div class="col-md-12 aftercheck">
									   ...
									   <label class="col-md-4 control-label">作业人员：<span class="required">*</span></label>
                                        ...
                                        <input type="text" id="afterTaskUserId" class="form-control" readonly data-required="1" />
											...
											<button type="button" class="btn btn-success" key="14" flag="0" id="saveAfterTask">保存</button>
										<button type="button" class="btn btn-primary" key="14" flag="1" id="submitAfterTask">确认</button>
										</div>
									</div>
								</div>
							</div>

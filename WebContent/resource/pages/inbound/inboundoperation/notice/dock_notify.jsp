	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title">&nbsp;接卸作业通知单(码头)</h5>
			</div>
			...
			<div class="input-group col-md-12">
				...
				<div class="portlet box blue">
					...
					<div class="tools">
								<a class="hidden-print" style="color: white;" onclick="InboundOperation.exportXML(this,11)"> <i class="fa fa-file-excel-o">&nbsp;导出</i>
								</a>
							</div>
						<!-- <div class="tools">
							...
							<div class="form-body">
								<table width="100%">
									...
									<tr>
										<td class="col-md-12">
											<div class="col-md-12" style="padding-left:0px;padding-right:0px;">
												<textarea class="form-control"  rows="3" id="docktaskmsg" ></textarea>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2">
											<h5>
												&nbsp;三.作业要求&nbsp;<a href="javascript:void(0);" onclick="InboundOperation.dialogShowMsg(1)"><i class="fa fa-file-text-o"></i></a>
									...
									<div class="modal-footer sureDiv">
									   ...
									   <label class="col-md-4 control-label">调度<span class="required">*</span></label>
									    ...
									    <button type="button" class="btn btn-success" key="4" flag="0" id="saveSureTask">保存</button>
										<button type="button" class="btn btn-primary" key="4" flag="1" id="submitSureTask">确认</button>
									</div>
									</td></tr>
									<tr>
										<td colspan="2"><h5>
								...
								<div class="form-body">
									<table width="100%" class="beforeTable">
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														...
														</label> <label class="checkbox-inline"><input type="checkbox" name="i" id="i3">不适用</label>
													</div>
												</div>
											</td>
										</tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														<label class="checkbox-inline"> <input type="checkbox" name="l" id="l1" value=""> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="l" id="l2" value=""> 否
														</label>
														<div class="lDiv" style="float:right;">
														<Button style="padding:3px 8px;" data="5" class="btn btn-primary spBtn" id="lSureBtn">确认</Button>
														</div>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="m" id="m1" value=""> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="m" id="m2" value=""> 否
														</label>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="n" id="n1" value=""> 是
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="o" id="o1" value="1"> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="o" id="o2" value="2"> 否
														</label>
													</div>
												</div>
											</td>
									...
									<div class="modal-footer beforeDiv" >
									   ...
									   <label class="col-md-4 control-label">作业人员<span class="required">*</span></label>
									    ...
									    <button type="button" class="btn btn-success" key="5" flag="0" id="saveBeforeTask">保存</button>
										<button type="button" class="btn btn-primary" key="5" flag="1" id="submitBeforeTask">确认</button>
									</div>
								</div>
								<div class="form-body">
									<table width="100%" class="inTable">
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="p" id="p1" value="1"> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="p" id="p2" value="2"> 否
														</label>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="q" id="q1" value="3"> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="q" id="q2" value="4"> 否
														</label>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list">
														<label class="checkbox-inline"> <input type="checkbox" name="r" id="r1" value="5"> 是
														</label> <label class="checkbox-inline"> <input type="checkbox" name="r" id="r2" value="6"> 否
														</label>
													</div>
												</div>
											</td>
									...
									<div class="col-md-8 form-horizontal">
									   ...
									   <button type="button" class="btn btn-success" key="6" flag="0" id="saveInTask">保存</button>
										<button type="button" class="btn btn-primary" key="6" flag="1" id="submitInTask">确认</button>
									</div>
								</div>
								<div class="form-body">
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														...
														<button style="padding:3px 8px;" type="button" data="7" class="btn btn-primary spBtn" id="sSureBtn">确认</button>
														</div>
													</div>
												</div>
											</td>
											...
											<td class="col-md-4">
												<div class="form-group">
													<div class="checkbox-list spCB">
														...
														<button style="padding:3px 8px;" type="button" data="7" class="btn btn-primary spBtn" id="tSureBtn">确认</button>
														</div>
													</div>
												</div>
											</td>
									...
									<div class="col-md-8 form-horizontal">
									   ...
									   <label class="col-md-4 control-label">作业人员<span class="required">*</span></label>
										...
										<button type="button" class="btn btn-success" key="7" flag="0" id="saveAfterTask">保存</button>
										<button type="button" class="btn btn-primary" key="7" flag="1" id="submitAfterTask">确认</button>
									</div>
									<div class="col-md-12">

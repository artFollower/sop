...
<div class="portlet box grey">
	<div class="portlet-title hidden">
		<div class="caption">添加靠泊方案</div>
	</div>
	<div class="portlet-body form berthplan">
		<form class="form-horizontal">
			<div class="form-body">
			    <shiro:hasPermission name="AINBOUNDASSESS">
				<button type="button" class="btn btn-info berthAssess">靠泊评估</button>
				</shiro:hasPermission>	
					...
					<div class="btn-group buttons  isChoiceBerth">
							<button class="btn btn-default btn-circle mar-r-10 check" type="button">
			...
			<shiro:hasPermission name="AINBOUNDBERTHINGVERIFYSC">
		...
		<div class="modal-footer firDiv">
			<button type="button" class="btn btn-default" data-dismiss="modal"
				...
				<shiro:hasPermission name="AINBOUNDBERTHINGUPDATE">
		...
		<div class="modal-footer secDiv">
			<button type="button" class="btn btn-default" data-dismiss="modal"
				onclick="javascript:history.go(-1);">返回</button>
				<shiro:hasPermission name="AINBOUNDBERTHINGVERIFY">
				<button type="button" key="2" class="btn btn-primary" id="save">通过</button>
				<!-- <button type="button" class="btn btn-primary passAndFinish" >通过并入库完成</button> -->
		...
		<!-- 调度验证码审批 -->
			...
			<div class="input-group col-md-6 col-md-offset-6" style="float:right;">
			 <input type="text" class="form-control" style="width:150px;float:right;" code="AINBOUNDBERTHINGVERIFY"  id="reviewCodeUserId" >	
                                ...
                                <input type="text" class="form-control" style="width:200px;float:right"  placeholder='请输入验证码' id="securityCode" >	
                                 <span class="input-group-btn">
                                 <button type="button" style="width:100px;text-align:center;" class="btn btn-primary" data="0" code="AINBOUNDBERTHINGVERIFY" onClick="SecurityCode.init(this)" id="securityCodeBtn">发送验证码</button>
                                 </span>
                              </div>
             <div class="form-group col-md-6 col-md-offset-6" style="margin-top:20px;float:right;" >
             <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			 <button type="button" key="2" code="AINBOUNDBERTHINGVERIFY" class="btn btn-primary" id="save">通过</button>
			 <button type="button" key="3" code="AINBOUNDBERTHINGVERIFY" class="btn btn-primary" id="submit">不通过</button>
             </div>
             </div>
			 </div>
			 </shiro:hasPermission>
...
<script>
$(function(){
	InboundOperation.initBerthPlan($(".berthplan"),1);
});
</script>
				...
				<form class="form-horizontal ">
					<div class="form-body berthassess">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control description" rows="3" id="reason" 
...
6、落实一条消拖两用拖轮协助靠泊。</textarea>
					...
					<shiro:hasPermission name="AINBOUNDASSESSVERIFYSC">
			...
			<div class="modal-footer firDiv">
				...
				<shiro:hasPermission name="AINBOUNDASSESSADD">
			...
			<div class="modal-footer secDiv">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
				<shiro:hasPermission name="AINBOUNDASSESSVERIFY">
					<button type="button" key="2" class="btn btn-primary" id="save">通过</button>
					<!-- <button type="button" key="4" class="btn btn-primary" id="submit">通过并提交</button> -->
			...
			<div class="input-group col-md-6 col-md-offset-6" style="float:right;">
							 <input type="text" class="form-control" style="width:150px;float:right;" code="AINBOUNDASSESSVERIFY"   id="reviewCodeUserId" >	
                                ...
                                <label id="securityCodeContent" class="hidden"></label>	
                                 <span class="input-group-btn">
                                 <button type="button" style="width:100px;text-align:center;" class="btn btn-primary" data="0" code="AINBOUNDASSESSVERIFY" onClick="SecurityCode.init(this)" id="securityCodeBtn">发送验证码</button>
                                 </span>
                              </div>
             <div class="form-group col-md-6 col-md-offset-6" style="margin-top:20px;float:right;" >
             <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			 <button type="button" key="2" code="AINBOUNDASSESSVERIFY" class="btn btn-primary" id="save">通过</button>
			 <button type="button" key="3" code="AINBOUNDASSESSVERIFY" class="btn btn-primary" id="submit">不通过</button>
             </div>
             </div>
			 </div>
			 </shiro:hasPermission>

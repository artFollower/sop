	...
	<div class="modal-dialog modal-wide" style="width:600px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">船舶进港确认单</h4>
			</div>
			
			<div class="form-group" style="padding-top: 10px;">
									<label class="control-label col-md-4">打印时间
										</label>
			<div
			...
			<div class="modal-body "  >
				...
				<div style="height: 31%">
				<label class="printS" style=" text-align: right ; float:right;" id="No"></label>
				<h4 class="printS" style=" text-align: center;font-family:宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;江苏长江石油化工有限公司</h4>
				<label class="printS" style=" text-align: right;float:right;font-size: 11px;">JL2106</label>
				<h4 class="printS" style=" text-align: center;font-family:宋体">船舶进港确认单</h4>
				
				<table class="printS" style="border:1px solid #000; width: 100%;font-size: 13px; " cellpadding="0" cellspacing="0" align='center'>
				
				 <tr>
				 
				    <td style="padding-left: 20px;padding-bottom:5px">生产运行部:</td>
				  </tr>
				  <tr>
				    <td style="padding-left: 30px;padding-bottom:5px" colspan="4">现有以下船舶即将停靠我公司码头，请对该船舶和接卸的货物予以确认。</td>
				  </tr>
				
				 <tr>
				    <td type="col-5" style="padding-left: 30px;">
								<div >
				  ...
				  <tr>
				    <td  type="col-5"  style="padding-left: 30px;">
							...
							<td  type="col-5"  >
								<div >
									<label type="col-7" id="arrivalTime">  </label>
								</div>
							</td>
				  ...
				  <tr>
				    <td  type="col-5"  style="padding-left: 30px;">
							...
							<td  type="col-5" >
								<div >
									<label  type="col-7" id="goodsTotal">  </label>
								</div>
							</td>
				  ...
				  <tr>
				    ...
				    <td  type="col-5"  style="padding-left: 20px;">
								<div >
									<label  type="col-3" >批号</label>
								</div>
							</td>
							
							<td  type="col-5"  >
								<div >
									<label  type="col-7" id="cargoCode"> </label>
								</div>
							</td>
				 ...
				 <tr>
				    <td  type="col-5"  style="padding-left: 30px;">
								<div >
									<label  type="col-3"  >附：</label>
								</div>
							</td>
							
				    <td  type="col-5" >
								<div >
									<label  type="col-7" > 客户通知</label>
								</div>
							</td>
				  </tr>
				...
				<label style="text-align: right ; float:right;font-size: 12px;font-family:宋体"> 第一联：生产运行部 </label>
